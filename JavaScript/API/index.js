let cityNameElement = document.querySelector('.weather_city');
...
const getWeatherData = async () => {
  const weatherUrl = `https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=f33a7eb9d3f8b4964fe7dc7924a19de4&units=metric`;
  ...
  try {
    ...
    cityNameElement.innerHTML = `${name}, ${getCountryName(sys.country)}`;
